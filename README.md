...
2. Save your *Mercury API key* (~~~apply for free [here](https://mercury.postlight.com/web-parser/)~~~ Postlight has stopped providing new API key, you can continue using your current API key.) in the *Mercury_fulltext settings* under **Feeds** tab.
